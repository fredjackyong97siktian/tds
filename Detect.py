...
def enable_mobileclip_pt_text_model():
    ...
    pt_path = os.path.join(base_dir, "mobileclip_blt.pt")
    if not os.path.isfile(pt_path):
        print(f"Warning: MobileCLIP PT not found: {pt_path}")
        return False
    try:
        import mobileclip
...
PERSON_MODEL_PATH = os.environ.get("KIOSK_PERSON_MODEL_PATH", os.path.join(BASE_DIR, "yolo26s.pt"))
TRACKER_PATH = os.environ.get("KIOSK_TRACKER_PATH", os.path.join(BASE_DIR, "custom_tracker.yaml"))
...
PRODUCT_MODEL_PATH = os.environ.get("KIOSK_PRODUCT_MODEL_PATH", os.path.join(BASE_DIR, "yolo26s.pt"))
...
POSE_MODEL_PATH = os.environ.get("KIOSK_POSE_MODEL_PATH", os.path.join(BASE_DIR, "yolo26l-pose.pt"))
